                      ...
                      children: [
                        ...
                        Expanded(
                          child: GestureDetector(
                            onTap: () async {
                              final result =
                                  await Get.toNamed(AppRoutes.cities);
                              if (result != null) {
                                // 切换到选中的城市
  ...
  Widget _buildSeasonTag(ThemeData theme) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: controller.seasonalColors.value?.primary.withValues(alpha: 0.1),
        borderRadius: BorderRadius.circular(20.r),
        border: Border.all(
          color:
              controller.seasonalColors.value?.primary ?? ZenColors.bambooGreen,
          width: 1,
        ),
      ),
      child: Row(
